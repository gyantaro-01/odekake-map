...
## 📖 コンセプト
散らばりがちな「子供が喜んだ場所」「また行きたい公園」の情報を、地図上に蓄積し、家族との思い出を資産化することを目的に作成しました。
...
## 🚀 特徴的な機能
- **認証**: パスワードによるアクセス制限を実装。家族以外のアクセスを遮断し、プライバシーを保護。
...
1.  `.env` ファイルを作成し、以下の情報を設定します。
    ...
    APP_PASSWORD=YOUR_SECRET_PASS  # アプリ起動用のパスワード
